...
void genelListele(int dizi1[4][6],int dizi2[4][6],int dizi3[4][6],int dizi4[4][6],int dizi5[4][6]);
void ilBirincilikleri(int il1_birinciParti, int il2_birinciParti, int il3_birinciParti, int il4_birinciParti, int il5_birinciParti);
...
int main() {
	...
	genelListele(il_1, il_2, il_3, il_4, il_5);
	ilBirincilikleri(il1_birinciParti, il2_birinciParti, il3_birinciParti, il4_birinciParti, il5_birinciParti);
...
//PARTÝLERÝN KAÇ ÝLDE BÝRÝNCÝ OLDUKLARINI BULAN FONKSÝYON
void ilBirincilikleri(int il1_birinciParti, int il2_birinciParti, int il3_birinciParti, int il4_birinciParti, int il5_birinciParti){
